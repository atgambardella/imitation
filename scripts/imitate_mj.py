...
def main(args):
    ...
    args['limit_trajs'] = 10
    args['data_subsamp_freq'] = 5
    args['cuts_off_on_success'] = 1
    args['sim_batch_size'] = 1
    args['min_total_sa'] = 5000
    args['max_iter'] = 301
    # MDP options
    args['max_traj_len'] = None
    # Policy architecture
    args['policy_hidden_spec'] = SIMPLE_ARCHITECTURE
    args['tiny_policy'] = False
    args['obsnorm_mode'] = 'expertdata'
    # Behavioral cloning optimizer
    args['bclone_lr'] = 1e-3
    args['bclone_batch_size'] = 128
    args['bclone_eval_ntrajs'] = 20
    args['bclone_eval_freq'] = 1000
    args['bclone_train_frac']  = .7
    # Imitation optimizer
    args['discount'] = .995
    args['lam'] = .97
    args['policy_max_kl'] = .01
    args['policy_cg_damping'] = .1
    args['no_vf'] = 0
    args['vf_max_kl'] = .01
    args['vf_cg_damping'] = .1
    args['policy_ent_reg'] = 0.
    args['reward_type'] = 'nn'
    args['reward_max_kl'] = .01
    args['reward_lr'] = .01
    args['reward_steps'] = 1
    args['reward_ent_reg_weight'] = .001
    args['reward_include_time'] = 0
    args['favor_zero_expert_reward'] = 1
    # Saving stuff
    args['print_freq'] = 1
    args['save_freq'] = 20
    args['plot_freq'] = 0
